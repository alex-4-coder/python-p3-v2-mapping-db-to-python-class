...
class Department:
    ...
    def save(self):
        """Insert a new row with the current Department's name and location.
        Update object id attribute using the primary key of the new row.
        Save the object in the local dictionary cache."""
    ...
    def delete(self):
        """Delete the table row, remove from dictionary cache, and reset id."""
    ...
    def instance_from_db(cls, row):
        """Return a Department object mapped from a table row."""
    ...
    def find_by_id(cls, id):
        """Return the Department object matching the given primary key id."""
    ...
    def find_by_name(cls, name):
        """Return the Department object matching the first row with the given name."""
